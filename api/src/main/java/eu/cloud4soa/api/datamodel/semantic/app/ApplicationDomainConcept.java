 ...
 * <ul>
 *   <li> Describedindocument </li>
 * </ul>
 *
 * This class was generated by <a href="http://RDFReactor.semweb4j.org">RDFReactor</a> on 9/16/11 12:57 PM
 * Modified version 0.1
 */
@RDFBean("http://www.imolinfo.it/ontologie/ea/v1.1/application-domain-model#Application_Domain_Concept")
public class ApplicationDomainConcept extends Thing {

	private Document describedindocument;
    ...
    @RDF("http://www.imolinfo.it/ontologie/ea/v1.1/documental-domain-model#is_described_in_document")
	public Document getDescribedindocument() {
		return describedindocument;
	}
	
	public void setDescribedindocument( Document describedindocument ) {
		this.describedindocument = describedindocument;
	}

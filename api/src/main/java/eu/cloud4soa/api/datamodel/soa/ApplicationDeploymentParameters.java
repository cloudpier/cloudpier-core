...
public class ApplicationDeploymentParameters {
    ...
    public InputStream getArchiveFileStream() {
        return archiveFileStream;
    }

    
    
    public void setArchiveFileStream(InputStream archiveFileStream) {

...
@RDFBean("http://www.cloud4soa.eu/v0.1/user-model#Developer")
...
//	@RDFSubject(prefix="http://www.cloud4soa.eu/v0.1/user-model#")
        @RDFSubject(prefix="http://www.cloud4soa.eu/v0.1/user-model/developers#")
    ...
    @RDF("http://www.cloud4soa.eu/v0.1/user-model#has_application")

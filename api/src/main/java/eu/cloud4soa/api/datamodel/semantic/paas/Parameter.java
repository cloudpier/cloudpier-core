...
@RDFBean("http://www.cloud4soa.eu/v0.1/paas-model#Parameter")
public class Parameter extends PlatformLayer {
    ...
    @RDF("http://www.cloud4soa.eu/v0.1/paas-model#isOptional")
    ...
    @RDF("http://www.cloud4soa.eu/v0.1/paas-model#hasValue")

...
@RDFBean("http://www.cloud4soa.eu/v0.1/measure#MeasurementRange")
public class MeasurementRange extends Utilities {
	...
	public String getUriId() {
        ...
        @RDF("http://www.cloud4soa.eu/v0.1/measure#isRequired")

...
import eu.cloud4soa.api.datamodel.semantic.foaf.Person;

@RDFBean("http://www.cloud4soa.eu/v0.1/user-model#User")
public class User extends Person {
    ...
    public OnlineAccount getHoldsaccount() {
            return (Cloud4SoaAccount)super.getHoldsaccount();
    }
   
    @Override
    public void setHoldsaccount(OnlineAccount holdsaccount) {
        assert holdsaccount instanceof Cloud4SoaAccount;
        super.setHoldsaccount(holdsaccount);
    }

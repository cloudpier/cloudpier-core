 ...
 */
@RDFBean("http://www.cloud4soa.eu/v0.1/measure#Measurement_Concept")
public class MeasurementConcept extends Thing {

	private Unit measuredas;
	...
	@Override
	@RDFSubject(prefix="http://www.cloud4soa.eu/v0.1/measure#Measurement_Concept/")
    ...
    @RDF("http://www.cloud4soa.eu/v0.1/measure#measured_as")
	public Unit getMeasuredas() {
		return measuredas;
	}
	
	public void setMeasuredas( Unit measuredas ) {
		this.measuredas = measuredas;
	}
    @RDF("http://www.cloud4soa.eu/v0.1/measure#has_quantity")

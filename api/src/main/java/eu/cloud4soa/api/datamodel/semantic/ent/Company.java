 ...
 * <ul>
 *   <li> Adoptapplication </li>
 * </ul>
 *
 * This class was generated by <a href="http://RDFReactor.semweb4j.org">RDFReactor</a> on 9/16/11 12:57 PM
 * Modified version 0.1
 */
@RDFBean("http://www.imolinfo.it/ontologie/ea/v1.0/enterprise-domain-model#Company")
public class Company extends Organization {

	private Application adoptapplication;
    ...
    @RDF("http://www.imolinfo.it/ontologie/ea/v1.1/application-domain-model#adopt_application")
	public Application getAdoptapplication() {
		return adoptapplication;
	}
	
	public void setAdoptapplication( Application adoptapplication ) {
		this.adoptapplication = adoptapplication;
	}

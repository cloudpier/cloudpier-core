...
@RDFBean("http://www.cloud4soa.eu/v0.1/infrastructural-domain#NetworkResource")
public class NetworkResource extends Network {

	private NetworkingRange bandwidth;
	private TimeRange latency;
    ...
    @RDF("http://www.cloud4soa.eu/v0.1/infrastructural-domain#latency")
	public TimeRange getLatency() {
		return latency;
	}
	
	public void setLatency( TimeRange latency ) {

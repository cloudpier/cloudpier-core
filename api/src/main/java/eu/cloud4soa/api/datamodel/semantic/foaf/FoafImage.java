 ...
 */
@RDFBean("http://xmlns.com/foaf/0.1/Image")
public class FoafImage extends Thing {

	private Thing depicts;
	private FoafImage thumbnail;
	...
	@Override
	@RDFSubject(prefix="http://xmlns.com/foaf/0.1/Image/")
    ...
    @RDF("http://xmlns.com/foaf/0.1/depicts")
	public Thing getDepicts() {
		return depicts;
	}
	
	public void setDepicts( Thing depicts ) {
		this.depicts = depicts;
	}
    @RDF("http://xmlns.com/foaf/0.1/thumbnail")
	public FoafImage getThumbnail() {
		return thumbnail;
	}
	
	public void setThumbnail( FoafImage thumbnail ) {

...
@RDFBean("http://www.cloud4soa.eu/v0.1/paas-model#Exception")
public class Exception extends PlatformLayer {
    ...
    @RDF("http://www.cloud4soa.eu/v0.1/paas-model#hasCondition")

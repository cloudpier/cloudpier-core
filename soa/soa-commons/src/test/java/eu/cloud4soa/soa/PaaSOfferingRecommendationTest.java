...
@ContextConfiguration(locations = {"classpath:**/UserExperienceRating.xml"})
public class PaaSOfferingRecommendationTest {
    ...
    Logger logger = LoggerFactory.getLogger(PaaSOfferingRecommendationTest.class);
    
    @Autowired
    private PaaSOfferingRecommendation paasOfferingRecommendation;
...
/*    @Before
    ...
    public void testInsertRateForMissingApp() throws SOAException {
        ...
        paasOfferingRecommendation.storeUserExperienceRate(appURI, rate);
    }
    ...
    public void testInsertRateForExistingApp() throws Exception {
        ...
        assertEquals( "In the database I should have " + userRateInserted.size() + " rates.",
                expectedNumberOfRates, userRateInserted.size());
    ...
    public void testLoadExistingRateByAppUriId() throws Exception {
        ...
        targetRate = paasOfferingRecommendation.getUserExperienceRate(APP2TEST_URIID);
    ...
    public void testUserExperienceRateDelete() throws Exception {
        ...
        paasOfferingRecommendation.deleteUserExperienceRate( APP4TEST_URIID );
    ...
    public void testUserExperienceRateUpdate() throws Exception {
        ...
        paasOfferingRecommendation.updateUserExperienceRate( APP3TEST_URIID, newRateValue );
        ...
        assertTrue( "The rate hasn't been modified", Integer.parseInt(newRateValue) == modifiedRate.getRate().intValue() );
    ...
    public void TestRetrieveAllPaasRates() throws Exception {
        ...
        ratesPerPaas1 = paasOfferingRecommendation.getPaaSUserExperienceEvaluation( PAAS1_URIID );
